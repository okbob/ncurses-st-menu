...
libst_menu.so: st_menu_styles.o st_menu.o
	gcc -shared -Wl,-soname,libst_menu.so.1 -o libst_menu.so.1 st_menu.o st_menu_styles.o
...
demo: demo.c libst_menu.so
	...
	gcc demo.c -o demo_sl -Wall -lncursesw -lpanel -lunistring -lst_menu -L. -DNCURSES_WIDECHAR=1 
