...
st_menu_styles.o: st_menu_styles.c st_menu.h
	gcc -fPIC st_menu_styles.c -o st_menu_styles.o -Wall -c -DNCURSES_WIDECHAR=1 -O3

st_menu.o: st_menu.h st_menu.c
	gcc -fPIC st_menu.c -o st_menu.o -Wall -c -DNCURSES_WIDECHAR=1 -O3
...
demo: demo.c libst_menu.so
	gcc demo.c -o demo libst_menu.a -Wall -lncursesw -lpanel -lunistring -DNCURSES_WIDECHAR=1 -O3
